...
//	For example, a customer can borrow WarGames on 21st February and they will be
...
//	You should make allowances for multiple copies of the same item (i.e. there can be
